...
*Reference: http://www.nber.org/docs/hcris/read_snf_rpt_nmrc.sas ;
...
proc printto log  ="/home/hcmg/kunhee/Labor/read_snf_rpt_nmrc&year..log";
proc printto print="/home/hcmg/kunhee/Labor/read_snf_rpt_nmrc&year..lst";
FILENAME datafile "/home/hcmg/kunhee/vertical-int/data/HCRIS/snf_nmrc2540_10_&year._long.csv";

*  The following line should contain the name of the SAS dataset ;

%let dataset = snf_nmrc_rpt&year._long ;
