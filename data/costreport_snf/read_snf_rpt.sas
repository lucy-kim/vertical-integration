options nocenter ;
*Read snfital cost report RPT file ;
*Reference: http://www.nber.org/docs/hcris/read_snf_rpt.sas ;

libname library "/home/hcmg/kunhee/vertical-int/data/HCRIS";
x "cd /home/hcmg/kunhee/vertical-int/data/HCRIS";

PROC FORMAT CNTLOUT=library.fsnf_rpt;
**************************************************;
...
** proc format cntlin=library.fsnf_rpt;
** PROC freq;
...
VALUE prvdr_ctrl_type_cd
       ...
       11    =  "Governmental snfital District"
...
/* proc printto log  ="/home/hcmg/kunhee/Labor/read_snf_rpt&year..log";
proc printto print="/home/hcmg/kunhee/Labor/read_snf_rpt&year..lst"; */

FILENAME datafile "/home/hcmg/kunhee/vertical-int/data/HCRIS/snf_rpt2540_10_&year..csv";

*  The following line should contain the name of the SAS dataset ;

%let dataset=library.snf_rpt2540_10_&year.;

data &dataset.;

*snf_dm.* files report lengths;
