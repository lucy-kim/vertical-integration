*options obs=55;
options nocenter;
*Read snfital cost report alphanumeric file ;
*Reference: http://www.nber.org/docs/hcris/read_snf_rpt_alphnmrc.sas ;
...
proc printto log  ="/home/hcmg/kunhee/vertical-int/data/HCRIS/read_snf_rpt_alphnmrc&year..log";
proc printto print="/home/hcmg/kunhee/vertical-int/data/HCRIS/read_snf_rpt_alphnmrc&year..lst";
FILENAME datafile "/home/hcmg/kunhee/vertical-int/data/HCRIS/snf_alpha2540_10_&year._long.csv";

*  The following line should contain the name of the SAS dataset ;
%let dataset=snf_alpha&year._long ;
