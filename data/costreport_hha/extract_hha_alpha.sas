options nocenter ;
*by Kunhee Kim, kunhee@wharton.upenn.edu, 2015-03-13 ;
*Extract some variables from the HHA ALPHA file from CMS HHA cost report data to construct the HHA cost report files for each HHA and for FY 1994-2014 (apply special conditions to 2000 since PPS effective on 10/01/2000);
    ...
    proc sql;
        *select appropriate worksheets;
        create table &dataset. as
            select *
            from library.hha_alpha&year._long
            where  (
        ...
        * Add varname;
        data library.&dataset.;
            ...
            * Medicare ;
            ...
            when (wksht_cd='S300000' and line_num='00900' and clmn_num='0200') varname = "aide_hrs_mcr";
            ...
            * Other payers;
            ...
            when (wksht_cd='S300000' and line_num='00900' and clmn_num='0400') varname = "aide_hrs_oth";
        ...
        proc contents;
          proc print data=library.&dataset (obs=50);
            *where wksht_cd="S300000" and (line_num="02500" or line_num="00600") ;
