...
df$gp <- factor(df$gp, levels=c("shref","comorbidsum","vi_snf","refhhi3","qual_read"), labels = c("A. Probability of referring to SNF","B. Comorbidity of SNF referred patients","C. Acquisition of SNF","D. SNF referral HHI","E. Baseline readmission performance of SNFs referred"))
# "Sum of share of discharges w/ comorbidities"

df$year <- df$fy
df$high <- factor(df$high, level= c(1,0), labels = c("High","Low"))


# all outcomes in a single figure:  "Impact of 1% increase in the predicted penalty rate for 2013"
ggplot(df) + facet_wrap(~gp, ncol=2, scale="free") +
...
# all other outcomes in a single figure:  "Impact of 1% increase in the predicted penalty rate for 2013"
