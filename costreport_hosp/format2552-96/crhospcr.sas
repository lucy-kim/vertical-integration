...
data &rpt.;
    ...
    *ownership status;
    ...
    length own_gv 3.;
    own_gv=0;
    if (prvdr_ctrl_type_cd>=1 and prvdr_ctrl_type_cd<=2) then own_np=1;
    if (prvdr_ctrl_type_cd>=3 and prvdr_ctrl_type_cd<=6) then own_fp=1;
...
%loopalpha(fyear=2000,lyear=2011);
%loopnmrc(fyear=2000,lyear=2011);
